...
REAL(EB) :: CPOPR,RSC,RPR,TMPA,TMPA4,RHOA,P_INF,&
            ...
            Y_WERNER_WENGLE=11.81_EB,PARTICLE_CFL_MAX=1.0_EB,LIMITING_DT_RATIO=1.E-4_EB,HRRPUVCUT_MAX=200._EB, &
...
INTEGER :: ICYC,WALL_INCREMENT,NFRAMES,PERIODIC_TEST=0,TURB_MODEL=0,EDDY_METHOD=1
...
REAL(EB) :: DT_VEG,VEG_CLOCK,BNDE_CLOCK,GEOM_CLOCK,UVW_TIMER(10)
...
INTEGER :: N_CONE_TREES,N_FRUSTUM_TREES,N_CYLINDER_TREES,N_RECTANGLE_TREES,N_CUSTOM_TREES,N_RING_TREES
...
!custom bulk veg volumes
REAL(EB), ALLOCATABLE, DIMENSION(:) :: XS_CUST_VEG,XF_CUST_VEG,YS_CUST_VEG,YF_CUST_VEG,ZS_CUST_VEG,ZF_CUST_VEG
...
LOGICAL :: CONE_TREE_PRESENT,FRUSTUM_TREE_PRESENT,CYLINDER_TREE_PRESENT,RING_TREE_PRESENT, &
           RECTANGLE_TREE_PRESENT,CUSTOM_TREE_PRESENT,IGNITOR_PRESENT
...
INTEGER, ALLOCATABLE, DIMENSION(:) :: N_TREE_OUT,TREE_CFCR_INDEX,TREE_FRUSTUM_INDEX,TREE_RING_INDEX,TREE_RECT_INDEX,TREE_CUSTOM_INDEX, &
                                      TREE_IGN_INDEX
...
REAL(EB), ALLOCATABLE, DIMENSION(:,:) :: FLUX0_LS,FLUX1_LS,HEAD_WIDTH,PHI_LS,PHI0_LS,PHI_TEMP,PHI1_LS,ROS_BACKU, &
                                         ...
                                         PHI_S,PHI_S_X,PHI_S_Y,PHI_W,PHI_W_X,PHI_W_Y,UMF_X,UMF_Y,ASPECT,BURN_TIME_LS, &
                                         CRUZ_CROWN_PROB
REAL(FB), ALLOCATABLE, DIMENSION(:,:) :: CRUZ_CROWN_PROB_OUT,FLI_OUT,MAG_SR_OUT,PHI_OUT,ROS_X_OUT,ROS_Y_OUT,TOA
