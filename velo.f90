...
print*,'PTEST'
IF (MAXVAL(U).GE.20) print*,'u=',MAXVAL(U)
IF (MAXVAL(V).GE.20) print*,'v=',MAXVAL(V)
IF (MAXVAL(W).GE.20) print*,'w=',MAXVAL(W)
...
USE MATH_FUNCTIONS, ONLY: EVALUATE_RAMP
USE TURBULENCE, ONLY: WERNER_WENGLE_WALL_MODEL, WALL_MODEL2
REAL(EB), INTENT(IN) :: T
               ...
               BOUNDARY_CONDITION: SELECT CASE(VELOCITY_BC_INDEX)
                  ...
                  CASE (WALL_MODEL) BOUNDARY_CONDITION
                     ...
                     ELSE
                        ...
                        CALL WALL_MODEL2(SLIP_COEF,U_TAU,Y_PLUS,VEL_GAS-VEL_T,MU_WALL/RHO_WALL,DXX(ICD),SF%ROUGHNESS)
                     ENDIF
