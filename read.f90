...
IF (FN_INPUT(1:1)==' ') THEN
   ...
   IF (MYID==0) THEN
      ...
      WRITE(LU_ERR,'(/A)')  "WFDS, April 10, 2015; based on subversion 9977 of FDS"
...
READ_PART_LOOP: DO N=1,N_PART
   ...
   VEG_ASH_FRACTION         = 0.03_EB !fraction of original dry fuel mass
   ...
   VEG_IGNITED              = .FALSE.
   VEG_H_H2O                = 2259._EB !kJ/kg/K heat of water vaporization
...
LOGICAL :: VEG_LSET_HEADWIDTH_DEPENDENCE,VEGETATION,VEGETATION_NO_BURN,VEGETATION_LINEAR_DEGRAD,VEGETATION_ARRHENIUS_DEGRAD, &
           VEG_LEVEL_SET_SPREAD,&
...
NAMELIST /SURF/ ADIABATIC,BACKING,BOUNDARY_CONDITION_FILENAME,BURN_AWAY,CELL_SIZE_FACTOR,COLOR,CONVECTION_LENGTH_SCALE, &
                ...
                VEG_LSET_ROS_FLANK,VEG_LSET_ROS_HEAD,VEG_LSET_WIND_EXP,VEL,VEL_T,VOLUME_FLUX,WIDTH,XYZ,Z0,VEG_LSET_SIGMA,VEG_LSET_HT,&
                VEG_LSET_BETA,VEG_LSET_ELLIPSE,VEG_LSET_TAN2,VEG_LSET_ELLIPSE_HEAD,VEG_LSET_HEADWIDTH_DEPENDENCE
