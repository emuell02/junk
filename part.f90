...
TREE_PARTICLES: IF (GAS_PC%TREE) THEN
   SFAC   = GAS_PC%VEG_DRAG_COEFFICIENT*GAS_P%VEG_SV*GAS_P%VEG_PACKING_RATIO*QREL*C_DRAG
   GAS_P%ACCEL_X  = SFAC*UREL !- GAS_P%VEG_MLR*UBAR/RHO_G removed because it appears to be
   GAS_P%ACCEL_Y  = SFAC*VREL !- GAS_P%VEG_MLR*VBAR/RHO_G double counting of the expansion
   GAS_P%ACCEL_Z  = SFAC*WREL !- GAS_P%VEG_MLR*WBAR/RHO_G which is already in the velocity divergence
