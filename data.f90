...
OUTPUT_QUANTITY(441)%NAME = 'VEG BULK DENSITY'                     
OUTPUT_QUANTITY(441)%UNITS = 'kg/m3'                       
OUTPUT_QUANTITY(441)%SHORT_NAME = 'vbd'

OUTPUT_QUANTITY(434:441)%PART_APPROPRIATE = .TRUE.
OUTPUT_QUANTITY(434:441)%SLCF_APPROPRIATE = .FALSE.
OUTPUT_QUANTITY(434:441)%DEVC_APPROPRIATE = .FALSE.
