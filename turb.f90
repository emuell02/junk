...
VENT_LOOP: DO NV=1,N_VENT
   ...
   SELECT CASE(EDDY_METHOD)
      ...
      CASE(2)
         VOLUME_WEIGHTING_FACTOR(1) = SQRT(1.875*945*VT%EDDY_BOX_VOLUME/(32*PI*REAL(VT%N_EDDY,EB)*EDDY_VOLUME(1))/MINVAL(VT%SIGMA_IJ(1,:)))
         VOLUME_WEIGHTING_FACTOR(2) = SQRT(1.875*945*VT%EDDY_BOX_VOLUME/(32*PI*REAL(VT%N_EDDY,EB)*EDDY_VOLUME(1))/MINVAL(VT%SIGMA_IJ(1,:)))
         VOLUME_WEIGHTING_FACTOR(3) = SQRT(1.875*945*VT%EDDY_BOX_VOLUME/(32*PI*REAL(VT%N_EDDY,EB)*EDDY_VOLUME(1))/MINVAL(VT%SIGMA_IJ(1,:)))
