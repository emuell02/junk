...
VENT_LOOP: DO NV=1,MESHES(NM)%N_VENT
   ...
   SELECT CASE(ABS(VT%IOR))
      CASE(1)
         ...
         VT%EDDY_BOX_VOLUME = (VT%X_EDDY_MAX-VT%X_EDDY_MIN+2*MAXVAL(VT%SIGMA_IJ(:,1)))*(VT%Y2-VT%Y1)*(VT%Z2-VT%Z1)
      CASE(2)
         VT%X_EDDY_MIN = VT%X1+MAXVAL(VT%SIGMA_IJ(:,1))
         VT%X_EDDY_MAX = VT%X2-MAXVAL(VT%SIGMA_IJ(:,1))
         VT%Y_EDDY_MIN = VT%Y1-MAXVAL(VT%SIGMA_IJ(:,2))
         ...
         VT%Z_EDDY_MIN = VT%Z1+MAXVAL(VT%SIGMA_IJ(:,3))
         VT%Z_EDDY_MAX = VT%Z2-MAXVAL(VT%SIGMA_IJ(:,3))
         VT%EDDY_BOX_VOLUME = (VT%X2-VT%X1)*(VT%Y_EDDY_MAX-VT%Y_EDDY_MIN+2*MAXVAL(VT%SIGMA_IJ(:,2)))*(VT%Z2-VT%Z1)
      CASE(3)
         VT%X_EDDY_MIN = VT%X1+MAXVAL(VT%SIGMA_IJ(:,1))
         VT%X_EDDY_MAX = VT%X2-MAXVAL(VT%SIGMA_IJ(:,1))
         VT%Y_EDDY_MIN = VT%Y1+MAXVAL(VT%SIGMA_IJ(:,2))
         ...
         VT%Z_EDDY_MIN = VT%Z1-MAXVAL(VT%SIGMA_IJ(:,3))
         VT%Z_EDDY_MAX = VT%Z2+MAXVAL(VT%SIGMA_IJ(:,3))
         VT%EDDY_BOX_VOLUME = (VT%X2-VT%X1)*(VT%Y2-VT%Y1)*(VT%Z_EDDY_MAX-VT%Z_EDDY_MIN+2*MAXVAL(VT%SIGMA_IJ(:,3)))
   END SELECT
...
VENT_LOOP: DO NV=1,N_VENT
   ...
   SELECT CASE(EDDY_METHOD)
      ...
      CASE(2)
         ...
         !print*,VT%EDDY_BOX_VOLUME,EDDY_VOLUME(1),MINVAL(VT%SIGMA_IJ(1,:)),SUM(VT%SIGMA_IJ(1,:))/3,VOLUME_WEIGHTING_FACTOR(1:3)
