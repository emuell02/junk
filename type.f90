...
TYPE PARTICLE_CLASS_TYPE
   ...
   REAL(EB) :: DENSITY,TMP_V=-1._EB,TMP_MELT=-1._EB,FTPR,HEAT_OF_COMBUSTION,ADJUST_EVAPORATION, &
               ...
               VEG_SV,VEG_MOISTURE,VEG_CHAR_FRACTION,VEG_ASH_FRACTION,VEG_DRAG_COEFFICIENT,VEG_BULK_DENSITY, &
...
TYPE WALL_TYPE
   ...
   REAL(EB) :: AREA_ADJUST=1._EB,AW=0._EB,DUWDT=0._EB,E_WALL,EW=0._EB,HEAT_TRANS_COEF=0._EB,KW=1._EB, &
               ...
               TW=0._EB,U_TAU=0._EB,UVW_GHOST=0._EB,UW=0._EB,UWS=0._EB,UW0=0._EB,XW=0._EB,Y_PLUS=1._EB,YW=0._EB,ZW=0._EB
...
TYPE SURFACE_TYPE
   ...
   LOGICAL :: VEG_LSET_HEADWIDTH_DEPENDENCE,VEG_LSET_IGNITE,VEG_LSET_SPREAD,VEG_LSET_ELLIPSE,VEG_LSET_TAN2
   REAL(EB) :: VEG_LSET_IGNITE_TIME,VEG_LSET_ROS_HEAD,VEG_LSET_ROTH_ZEROWINDSLOPE_ROS,VEG_LSET_QCON,VEG_LSET_ROS_FLANK, &
               VEG_LSET_ROS_BACK, &
               ...
               VEG_LSET_CRUZ_PROB_PASSIVE,VEG_LSET_CRUZ_PROB_ACTIVE,VEG_LSET_CRUZ_PROB_CROWN
...
TYPE FACET_TYPE
   ...
   REAL(EB) :: NVEC(3)=0._EB,TMP_F=300._EB,TMP_G=300._EB,AREA=0._EB,U_TAU=0._EB,Y_PLUS=1._EB
...
TYPE VENTS_TYPE
   ...
   REAL(EB), POINTER, DIMENSION(:,:) :: U_EDDY,V_EDDY,W_EDDY,UT1,UT2,UT3
