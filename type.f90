...
TYPE PARTICLE_CLASS_TYPE
   ...
   REAL(EB) :: DENSITY,TMP_V=-1._EB,TMP_MELT=-1._EB,FTPR,HEAT_OF_COMBUSTION,ADJUST_EVAPORATION, &
               ...
               REAL_REFRACTIVE_INDEX,COMPLEX_REFRACTIVE_INDEX,TOL_INT,VEG_CHAR_ENTHALPY_FRACTION,VEG_CHAR_MPV_MIN
...
TYPE WALL_TYPE
   ...
   REAL(EB), POINTER, DIMENSION(:) :: VEG_CHARMASS_L,VEG_FUELMASS_L,VEG_MOISTMASS_L,VEG_TMP_L
   REAL(EB) :: VEG_HEIGHT
...
TYPE SURFACE_TYPE
   ...
   LOGICAL :: VEG_LSET_HEADWIDTH_DEPENDENCE,VEG_LSET_SPREAD,VEG_LSET_ELLIPSE,VEG_LSET_TAN2
   REAL(EB) :: VEG_LSET_IGNITE_T,VEG_LSET_ROS_HEAD,VEG_LSET_ELLIPSE_HEAD,VEG_LSET_ROS_FLANK,VEG_LSET_ROS_BACK,VEG_LSET_WIND_EXP
